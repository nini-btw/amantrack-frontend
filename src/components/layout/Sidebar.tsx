  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="flex h-16 items-center justify-center border-b border-gray-800 dark:border-[#2d3340] bg-gray-950 dark:bg-[#0d1117] px-3 cursor-pointer select-none"
      >
        {isCollapsed ? (
