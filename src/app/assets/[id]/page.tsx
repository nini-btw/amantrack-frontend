          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-lg text-gray-900">{asset.referenceNumber}</p>
              </div>
              <div>
                <span className="text-sm font-medium text-gray-600">Type:</span>
                <p className="text-lg text-gray-900">{asset.type}</p>
              </div>
              <div>
                <span className="text-sm font-medium text-gray-600">
                  Location:
              ...
              <div>
                ...
                <p className="text-lg text-gray-900">{asset.class}</p>
              </div>
              <div>
                <span className="text-sm font-medium text-gray-600">
                  Weight:
                </span>
                <p className="text-lg text-gray-900">{asset.weightKg} kg</p>
              </div>
            </div>
          </div>
